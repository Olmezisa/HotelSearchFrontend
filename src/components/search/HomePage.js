  ...
  return (
    <div className="bg-[#F9F7F3]">
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-20 bg-white/50 rounded-3xl mx-4 mb-10 backdrop-blur-sm">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black bg-gradient-to-r from-[#F7A072] via-[#EDDEA4] to-[#B5E2FA] text-transparent bg-clip-text mb-4">
            Popüler Oteller
          </h2>
          <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
    ...
    <div key={index} className="min-w-[340px] bg-white border border-gray-200 rounded-2xl shadow-lg snap-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer group">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-gradient-to-r from-[#F7A072] to-[#F9B18B] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-[#F7A072]/90 hover:to-[#F9B18B]/90 transition-all duration-300 transform hover:scale-105">
            Detaylar
          </button>
        </div>
      </div>
