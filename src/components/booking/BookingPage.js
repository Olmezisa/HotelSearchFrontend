    ...
    <div className="min-h-screen bg-[#F9F7F3] font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-7 border border-[#88B8D2]/20">
              ...
              <button
                onClick={handleBooking}
                className="w-full bg-gradient-to-r from-[#2781B9] to-[#093B5A] hover:from-[#093B5A] hover:to-[#2781B9] text-white py-4 px-6 rounded-xl font-bold text-xl transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg mb-4"
                disabled={isSavingGuestInfo}
              >
                {isSavingGuestInfo ? 'Bilgiler Kaydediliyor...' : '📞 Hızlı Rezervasyon'}
              </button>
      ...
      {showBookingSuccessModal && (
        <div className="fixed inset-0 bg-[#093B5A]/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl p-8 max-w-sm w-full text-center transform scale-95 animate-fade-in border border-[#88B8D2]/20">
            <CheckCircle className="w-16 h-16 text-[#2781B9] mx-auto mb-5" />
            <h2 className="text-2xl font-bold text-[#093B5A] mb-3">Rezervasyon Başarılı!</h2>
            <p className="text-[#2781B9] mb-6">Rezervasyonunuz başarıyla tamamlandı. Onay e-postanız gönderildi.</p>
            <button
              onClick={() => setShowBookingSuccessModal(false)}
              className="bg-gradient-to-r from-[#D48A61] to-[#AC440B] hover:from-[#AC440B] hover:to-[#D48A61] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 w-full"
            >
              Tamam
            </button>
          </div>
